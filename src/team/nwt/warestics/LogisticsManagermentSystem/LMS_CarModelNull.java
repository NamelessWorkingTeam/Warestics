...
public class LMS_CarModelNull extends AbstractTableModel {
    ...
    //通过传递的sql语句来获得数据模型
    public LMS_CarModelNull(String sql)
    {
    	//建立表头  
    ...
    public LMS_CarModelNull()
    {
		...
		RowData=new Vector(); 
		sql = "select car_currentposition,car_currentposition,car_currentposition,"
				+ "car_currentposition,car_currentposition,"
				+ "car_currentposition,car_currentposition from tb_order,"
